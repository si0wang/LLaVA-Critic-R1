...
def eval_model(args):
    ...
    questions = list(load_dataset("XAI/vlmsareblind", split="valid"))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--is-mimo-thinking", action="store_true", help="Append <think> tag at the end of prompt")
